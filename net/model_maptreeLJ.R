#' #algorith modified from ggClusterNet model_maptree2 by Jian Liu,add the return of the igraph object.
...
model_maptreeLJ = function(
  ...
  netClu <- netClu %>% full_join(igraph.degree,na_matches = "never")
  ...
  return(list(node,netClu2,branch,igraph,fc))
}
